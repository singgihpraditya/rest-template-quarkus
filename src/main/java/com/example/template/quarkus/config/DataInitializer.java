...
import com.example.template.quarkus.entity.*;
import com.example.template.quarkus.repository.*;
...
public class DataInitializer {
    ...
    private void seedPermissions() {
        List<EndpointPermission> permissions = List.of(
                ...
                perm(2, "POST", "/api/auth/login", null, "Login publik"),
                perm(3, "POST", "/api/auth/register", null, "Register publik"),
                perm(4, "GET", "/q/swagger-ui/**", null, "Swagger UI"),
                perm(5, "GET", "/q/openapi", null, "OpenAPI spec"),
                perm(6, "GET", "/q/health/**", null, "Health check"),
                perm(7, "GET", "/q/metrics", null, "Metrics"),
                perm(8, "*", "/h2-console/**", null, "H2 Console (local only)"),
